...
Look for `blaze-0.7.0-feature.47.9-standalone.jar`.
...
```
DATABASE_URI=datomic:free://localhost:4334/db java -server -Xms2g -Xmx2g -XX:+UseG1GC -jar blaze-0.7.0-feature.47.9-standalone.jar
```
